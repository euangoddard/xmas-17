  ...
  render() {
    return <div class={style.about}>
      ...
      <p>
        ...
        learn <a href="https://preactjs.com/" target="_blank">Preact</a>. It is available as an installable progressive web app (i.e. works offline) &ndash; this was achieved
